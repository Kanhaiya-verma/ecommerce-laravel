            ...
            <div class="navbar-right ">
                ...
                <div class="search-form">
                    ...
                    <ul class="dropdown-menu dropdown-menu-search">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('home') }}">Morbi leo risus</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('home') }}">Dapibus ac facilisis in</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('home') }}">Porta ac consectetur ac</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ route('home') }}">Vestibulum at eros</a>
                        </li>
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="all" role="tabpanel"
                                        ...
                                        <div class="media media-sm bg-warning-10 p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="source/images/user/user-sm-02.jpg" alt="User Image">
                                                </a>
                                            </div>
                                        ...
                                        <div class="media media-sm p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="source/images/user/user-sm-03.jpg" alt="User Image">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <a href="user-profile.html">
                                    ...
                                    <div class="tab-pane fade" id="message" role="tabpanel"
                                        ...
                                        <div class="media media-sm p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="source/images/user/user-sm-01.jpg" alt="User Image">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <a href="user-profile.html">
                                        ...
                                        <div class="media media-sm p-4 mb-0">
                                            <div class="media-sm-wrapper">
                                                <a href="user-profile.html">
                                                    <img src="source/images/user/user-sm-04.jpg" alt="User Image">
                                                </a>
                                            </div>
                                            <div class="media-body">
                                                <a href="user-profile.html">
                        ...
                        <div class="card-header">
                            ...
                            <div class="dropdown">
                                <a class="dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> Yearly
                                    Chart
                                </a>
                        ...
                        <div class="card-body">
                            <table id="productsTable" class="table table-hover table-product" style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-01.jpg" alt="Product Image">
                                        </td>
                                        <td>Coach Swagger</td>
                                        <td>24541</td>
                                        <td>27</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-02.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-03.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-04.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-05.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-06.jpg" alt="Product Image">
                                        </td>
                                        <td>Olay</td>
                                        <td>24546</td>
                                        <td>19</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-07.jpg" alt="Product Image">
                                        </td>
                                        <td>Ledger Nano X</td>
                                        <td>24547</td>
                                        <td>61</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-08.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-09.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-10.jpg" alt="Product Image">
                                        </td>
                                        <td>Wattbike Atom</td>
                                        <td>24550</td>
                                        <td>61</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-11.jpg" alt="Product Image">
                                        </td>
                                        <td>Smart Watch</td>
                                        <td>24551</td>
                                        <td>19</td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-12.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-13.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-14.jpg" alt="Product Image">
                                        </td>
                                    ...
                                    <tr>
                                        <td class="py-0">
                                            <img src="source/images/products/products-xs-15.jpg" alt="Product Image">
                                        </td>
                                        <td>Headphones</td>
                                        <td>24555</td>
                                        <td>17</td>
...
<div class="card card-offcanvas" id="contact-off">
    ...
    <div class="card-body">
        ...
        <div class="media media-sm">
            <div class="media-sm-wrapper">
                <a href="user-profile.html">
                    <img src="{{ url('source/images/user/user-sm-01.jpg') }}" alt="User Image">
        ...
        <div class="media media-sm">
            <div class="media-sm-wrapper">
                <a href="user-profile.html">
                    <img src="{{ url('source/images/user/user-sm-02.jpg') }}" alt="User Image">
                    <span class="active bg-primary"></span>
                </a>
            </div>
            <div class="media-body">
        ...
        <div class="media media-sm">
            <div class="media-sm-wrapper">
                <a href="user-profile.html">
                    <img src="{{ url('source/images/user/user-sm-03.jpg') }}" alt="User Image">
                </a>
            </div>
            <div class="media-body">
                <a href="user-profile.html">
        ...
        <div class="media media-sm">
            <div class="media-sm-wrapper">
                <a href="user-profile.html">
                    <img src="{{ url('source/images/user/user-sm-04.jpg') }}" alt="User Image">
                </a>
        ...
        <div class="media media-sm">
            <div class="media-sm-wrapper">
                <a href="user-profile.html">
                    <img src="{{ url('source/images/user/user-sm-05.jpg') }}" alt="User Image">
        ...
        <div class="media media-sm">
            <div class="media-sm-wrapper">
                <a href="user-profile.html">
                    <img src="{{ url('source/images/user/user-sm-06.jpg') }}" alt="User Image">
                    <span class="active bg-primary"></span>
                </a>
            </div>
            <div class="media-body">
...
<script src="{{ url('source/plugins/toaster/toastr.min.js') }}"></script>



<script src="{{ url('source/js/mono.js') }}"></script>
<script src="{{ url('source/js/chart.js') }}"></script>
<script src="{{ url('source/js/map.js') }}"></script>
